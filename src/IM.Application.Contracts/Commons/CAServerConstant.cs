...
public class CAServerConstant
{
    public const string HolderInfo = "api/app/imUsers/holder";
    public const string HolderInfos = "api/app/imUsers/holders";
    public const string ContactList = "api/app/contacts/list";
    public const string ContactsPost = "api/app/contacts";
    public const string ContactsGet = "api/app/contacts/";
    public const string ContactsExist = "api/app/contacts/existByUserId/";
